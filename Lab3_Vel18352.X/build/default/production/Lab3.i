...
loop:
    ...
    btfss ((INTCON) and 07Fh), 2 ;Si el bit es 1 en ((INTCON) and 07Fh), 2 skipea el goto
...
config_reloj:
    ...
    bsf ((OSCCON) and 07Fh), 4 ;IRCF<2:0> = 011 ---> 500KHz
...
config_TMR0:
    ...
    bsf ((OPTION_REG) and 07Fh), 0 ;PS<2:0> = 111 ---> 1:256
    banksel PORTB
    call reinicio_TMR0
    return
